        ...
        data.venues.forEach((venue) => {
          ...
          card.innerHTML = `
            <div class="relative">
              ...
              <button data-venue="${venue.id}" class="wishlist-button absolute right-3 top-3 rounded-full border border-white/30 bg-white/10 p-2 text-white transition hover:bg-white/20" aria-label="Toggle wishlist" aria-pressed="${venue.wishlisted ? 'true' : 'false'}">
